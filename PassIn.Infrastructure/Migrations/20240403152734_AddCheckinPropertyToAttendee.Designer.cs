...
namespace PassIn.Infrastructure.Migrations
{
    ...
    [Migration("20240403152734_AddCheckinPropertyToAttendee")]
    partial class AddCheckinPropertyToAttendee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PassIn.Infrastructure.Entities.CheckIn", b =>
                {
                    b.HasOne("PassIn.Infrastructure.Entities.Attendee", "Attendee")
                        .WithOne("CheckIn")
                        .HasForeignKey("PassIn.Infrastructure.Entities.CheckIn", "AttendeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
